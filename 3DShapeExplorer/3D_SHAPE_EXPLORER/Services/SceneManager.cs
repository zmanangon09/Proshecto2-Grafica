...
namespace _3D_SHAPE_EXPLORER.Services
{
    public class SceneManager
    {
        ...
        public int? SelectedShapeIndex = null;

        // Sistema de cámara 3D orbital
        public CameraController Camera { get; private set; } = new CameraController();
        ...
        public void Initialize()
        {
            ...
            // Establecer vista isométrica por defecto para mejor visualización 3D
        ...
        /// <summary>
        /// Obtiene información del estado actual de la escena
        /// </summary>
        public string GetSceneInfo()
        {
            string info = $"Figuras: {Shapes.Count}";
            var selected = Shapes.FirstOrDefault(s => s.IsSelected);
            if (selected != null)
            {
                int idx = Shapes.IndexOf(selected);
                info += $" | Seleccionada: #{idx + 1} ({selected.GetType().Name})";
            }
            return info;
        }
        /// <summary>
